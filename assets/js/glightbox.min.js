    ...
    function F(e, t, i, n) {
        ...
        "file" == u && (u = "http"), r.style.maxWidth = t.width, S(this.settings.plyr.js, "Plyr", (function () {
            ...
            if (c.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) || c.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/) || c.match(/(youtube\.com|youtube-nocookie\.com)\/embed\/([a-zA-Z0-9\-_]+)/)) {
                ...
                g = "youtube", v = r
            }else if (c.match(/(tiktok\.com)\/(@[^\/]+\/video\/|v\/)([0-9]+)/) ||
                c.match(/(vm\.tiktok\.com)\/([a-zA-Z0-9]+)/)) {
                // Xử lý TikTok
                var tiktokId = '';
                var tiktokMatch = c.match(/(tiktok\.com)\/(@[^\/]+\/video\/|v\/)([0-9]+)/) ||
                    c.match(/(vm\.tiktok\.com)\/([a-zA-Z0-9]+)/);

                if (tiktokMatch) {
                    tiktokId = tiktokMatch[3] || tiktokMatch[2];
                    g = "tiktok", v = tiktokId;
                }
            }else {
